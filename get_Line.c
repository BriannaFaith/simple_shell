#include "shell.h"
/**
 * _getline - Reads a single line of input from the prompt.
...
/**
 * check_logic_ops - Inspects and splits commands based on '&&' and '||' operators.
 * @array_commands: Array of commands to be checked and modified.
