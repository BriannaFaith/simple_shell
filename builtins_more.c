#include "shell.h"
/**
 * builtin_exit - is the exit of the program with the status
...
/**
 * builtin_cd - this function changes the current directory
...
/**
 * set_work_directory - this sets the work directory
 * @data:a struct for the program's data
 * @new_dir: the new path to be set as work directory
 * Return: zero if sucess, or other number if its declared in the arguments
 */
