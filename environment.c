#include "shell.h"
/**
 * env_get_key - this function gets the value of an environment variable
...
/**
 * env_remove_key - this function removes a key from the environment
...
int env_remove_key(char *key, data_of_program *data)
{
	...
	/* obtains leng of the variable requested */
	key_length = str_length(key);
